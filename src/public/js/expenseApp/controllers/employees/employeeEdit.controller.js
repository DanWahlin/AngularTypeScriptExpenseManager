...
(function (expenseApp) {
    ...
    (function (employees) {
        ...
        var EmployeeEditController = (function () {
            ...
            EmployeeEditController.prototype.saveEmployee = function () {
                ...
                if (this.$scope.editForm.$valid) {
                    if (!this.employee.id) {
                        ...
                        this.dataService.updateEmployee(this.employee).then(function (status) {
                            _this.processSuccess();
            ...
            EmployeeEditController.$inject = ['$scope', '$location', '$routeParams', '$timeout',
...
//# sourceMappingURL=../../../expenseApp/controllers/employees/employeeEdit.controller.js.map